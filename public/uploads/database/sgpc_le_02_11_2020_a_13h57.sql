...
INSERT INTO storageCard  values ('5', '1', '13', '', '', '', '', '400', '500', '10 mol/L', '', '', '', '', '', '0', '0', '1');
INSERT INTO storageCard  values ('6', '1', '15', '', '1', '1', '2', '250', '250', '98 %', '', '', '', '', '6046-93-1', '0', '0', '1');
INSERT INTO storageCard  values ('7', '1', '14', '', '', '', '', '15', '500', '', '', '', '2020-10-22', '', '', '0', '0', '1');
#
...
INSERT INTO user  values ('4', '3', '1', 'responsable', 'Utilisateur Responsable', 'responsable@test.fr', '$argon2id$v=19$m=65536,t=4,p=1$UUZFemlWYkJaMFkzVVQzcg$WhTghljtwRd0aZdXSvljDhrvhkh1g0PO42xbFYOTjr0', '');
...
CREATE TABLE `movedhistory` (
  ...
  CONSTRAINT `FK_movedhistory_storagecard` FOREIGN KEY (`id_storagecard`) REFERENCES `storagecard` (`id_storageCard`),
...
INSERT INTO movedhistory  values ('7', '7', '1', '4', '2020-10-26');
#
...
#
INSERT INTO tracability  values ('1', '4', '5', '2020-10-26', '');
INSERT INTO tracability  values ('2', '4', '5', '2020-10-26', '');
#
...
CREATE TABLE `controlbytype` (
  ...
  `isCompatible` tinyint(1) NOT NULL,
